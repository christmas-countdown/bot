...
module.exports = class MinutesCommand extends Command {
	constructor(client) {
		super(client, {
			description: 'Get the number of minutes left until Christmas',
			name: 'minutes'
		});
	}
	...
	async execute(interaction) {
		...
		const title = christmas.isToday()
			...
			: christmas.isTomorrow()
				...
				: i18n('commands.minutes.title', minutes, { minutes: formatted });
		const text = [
			i18n('commands.minutes.description', minutes, { minutes: formatted }),
			i18n('countdown.live', {
